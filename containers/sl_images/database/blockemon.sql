...
--
-- Host: localhost    Database: blockemon
-- ------------------------------------------------------
...
CREATE TABLE `accounts` (
  ...
  `starting_block` int(11) NOT NULL,
  `private_key` blob NOT NULL,
  `public_key` blob NOT NULL,
  `contact_list` blob NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`),
  UNIQUE KEY `eth_addr` (`eth_addr`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

DROP TABLE IF EXISTS `external_mails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `external_mails` (
  `secret_hash` varchar(50) NOT NULL,
  `ipfs_hash` varchar(50) NOT NULL,
...
-- Dump completed on 2017-05-05 14:26:56
